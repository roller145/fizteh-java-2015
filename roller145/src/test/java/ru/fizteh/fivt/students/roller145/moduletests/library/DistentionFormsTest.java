...
public class DistentionFormsTest extends TestCase {
    ...
    public void testGetCorrectForm() throws Exception {
        ...
        assertEquals(DistentionForms.RETWEET_FORMS[getCorrectForm(1).getType()], "ретвит");
        assertEquals(testing.DisForm(2, DistentionForms.ETime.HOUR), " часа");
        assertEquals(testing.DisForm(3, DistentionForms.ETime.MINUTE), " минуты");
    }
